...
#include <stdio.h>
#include <time.h>
/////////// FUNÇÃO PARA GERA OS ENREÇOES EM UM ARQUIVO/////
/////////// ESSA FUNÇÃO E CHAMADA NO INDEX ////////////////
...
for(W=1;W<=2;W++){
         ...
         for(i=0;i<50;i++){
            ...
            //////////////////////////////////// GRAMA /////////////
                    ...
                    for(i=0;i<25;i++){
                        if(A[i]<10){
                            fprintf(gramaT,"DataSet\\\\asphalt\\\\grass_0%d.txt\n",A[i]);
                        }else{
                            fprintf(gramaT,"DataSet\\\\asphalt\\\\grass_%d.txt\n",A[i]);
                        }
                    }

                    for(i=0;i<25;i++){
                         if(B[i]<10){
                            fprintf(gramaV,"DataSet\\\\asphalt\\\\grass_0%d.txt\n",B[i]);
                         }else{
                            fprintf(gramaV,"DataSet\\\\asphalt\\\\grass_%d.txt\n",B[i]);
                         }
                    }
                    fclose(gramaT);
                    fclose(gramaV);
